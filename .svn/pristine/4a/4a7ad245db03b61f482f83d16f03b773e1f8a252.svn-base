...
public class BrowserHistoryPage extends ExpandableListActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mHomeLinkPosition = getIntent().getStringExtra(HomeLinks.POSITION);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        if (!(mMenuInfo.targetView instanceof HistoryItem)) {
            return;
        }

        historyItem = (HistoryItem) mMenuInfo.targetView;
        ...
        dialog.setItems(meunus, new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                switch (arg2) {
                    ...
                    case 2:
                        if (historyItem.isBookmark()) {
                            Bookmarks.removeFromBookmarks(BrowserHistoryPage.this,
                                    getContentResolver(),
                                    url, title);
                        } else {
                            Browser.saveBookmark(BrowserHistoryPage.this, title, url);
                        }
                        break;
                    case 3:
                        Browser.sendString(BrowserHistoryPage.this, url,
    ...
    public boolean onChildClick(ExpandableListView parent, View v,
        ...
        if (mHomeLinkPosition != null) {
            Context context = BrowserHistoryPage.this;
            String url = ((HistoryItem) v).getUrl();
            String title = ((HistoryItem) v).getName();
            if (HomeLinks.saveHomeLink(context, url, title)) {
                ...
                try {
                     ...
                     * HomeLinks.createIconBitmap(draw, context);
