...
public class Constants {
    ...
    public static final String DEFAULT_DL_SUBDIR = "/Deneb_Browser/Download";

    /** Where we store downloaded files on the external storage */
    public static final String CHINA_DEFAULT_DL_SUBDIR = "/Cygnus_Browser/Download";
    public static final String FRENCH_DEFAULT_DL_SUBDIR = "/Deneb_Browser/Download";

    public static final String CHINA_DL_DESTINATION = "Cygnus Browser";
    public static final String FRENCH_DL_DESTINATION = "Deneb Browser";
    ...
    public static final boolean LOGV = false;// Config.LOGV
    ...
    /**
     * control whether need to auto start the {@link DownloadService}.
     */
