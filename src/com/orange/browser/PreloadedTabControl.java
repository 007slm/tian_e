...
public class PreloadedTabControl {
    ...
    public void setQuery(String query) {
    	//TODO by lijw maybeSetQuery(query, mTab.getWebView().getSearchBox());
    }

    public boolean searchBoxSubmit(final String query,
            final String fallbackUrl, final Map<String, String> fallbackHeaders) {
        final SearchBox sb = null;//TODO by lijw mTab.getWebView().getSearchBox();
        if (sb == null) {
    ...
    public void searchBoxCancel() {
        SearchBox sb = null; //TODO by lijwmTab.getWebView().getSearchBox();
        if (sb != null) {
            mLastQuery = null;
