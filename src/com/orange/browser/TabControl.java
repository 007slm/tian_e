...
class TabControl {
    ...
    interface OnWindowNumChangedListener{
        void onWindowNumChanged(int num);
    }
    private OnWindowNumChangedListener mWindowNumChangedListener;
    public void setOnWindowNumChangedListener(OnWindowNumChangedListener listener){
        mWindowNumChangedListener=listener;
    }
    ...
    TabControl(Controller controller) {
        ...
        mActivity = (BrowserActivity)controller.getActivity();
    }
    ...
    Tab createNewTab(Bundle state, boolean privateBrowsing) {
        ...
        t.putInBackground();
        if(mWindowNumChangedListener!=null){
            mWindowNumChangedListener.onWindowNumChanged(getTabCount());
        }
        return t;
    }
