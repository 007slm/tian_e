...
//    private AnimScreen mAnimScreen;
    protected NavigationBarPhone mNavigationBar;
...
//                browser.getResources().getDisplayMetrics());
    ...
    public void onDestroy() {
        hideTitleBar();
        mWindowsManager.destroyBitmapCache();
    }
...
//        updateLockIconToLatest(tab);
    ...
    public void updateMenuState(Tab tab, Menu menu) {
        ...
        if (bm != null) {
            bm.setVisible(true);
            bm.setTitle(R.string.add_to_bookmarks_menu_option);
        }
        MenuItem bm2 = menu.findItem(R.id.view_downloads_menu_id);
        if (bm2 != null) {
            bm2.setVisible(true);
            bm2.setTitle("view downoads");
        }
