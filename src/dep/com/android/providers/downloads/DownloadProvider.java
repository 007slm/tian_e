...
public final class DownloadProvider extends ContentProvider {
    ...
    static {
        sURIMatcher.addURI("orangedownloads", "downloads", DOWNLOADS);
        sURIMatcher.addURI("orangedownloads", "downloads/#", DOWNLOADS_ID);
    }
    ...
    public Uri insert(final Uri uri, final ContentValues values) {
        ...
        if(url!=null&&url.startsWith("file://")){
            filteredValues.put(Downloads.Impl.COLUMN_STATUS, 200);
            filteredValues.put(Downloads.Impl._DATA, values.getAsString(Downloads.Impl._DATA));
            filteredValues.put(Downloads.Impl.COLUMN_TOTAL_BYTES, values.getAsString(Downloads.Impl.COLUMN_TOTAL_BYTES));
            filteredValues.put(Downloads.Impl.COLUMN_DESCRIPTION,getContext().getResources().getString(R.string.screenshot));
        }
        ...
        if (rowID != -1&&!(url!=null&&url.startsWith("file://"))) {
            context.startService(new Intent(context, DownloadService.class));
